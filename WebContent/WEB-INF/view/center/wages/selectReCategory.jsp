	...
	<div class="bodys">
		...
		<div class="container-fluid" id="mains">
			<div class="left-container" id="left-container">
				...
				<ul>
					<c:if test="${type==0 }">
						...
						<li><a href="${pageContext.request.contextPath}/center/wagesParent/insertRePayroll" style="color: #ffb900;">新增补发工资单</a></li>
					</c:if>
					<c:if test="${type!=1 }">
			...
			<div class="main-container">
				<form id="addReWagesForm" class="form-horizontal" method="post"
					enctype="multipart/form-data"
					action="${pageContext.request.contextPath}/center/wagesParent/reUploadSpringMvcSingleFile">
					<div class="form-group rusults">
						<label for="company-name" class="col-sm-6 control-label">新增<font color="red">补发</font>工资单</label>
					</div>
					<div class="borders-info">
						<div class="form-group">
							<label for="id-type" class="col-sm-4 control-label"><span
								style="color: red; margin-right: 5px;" id="itspan1s">*</span>补发工资单年份:</label>
						...
						<div class="form-group">
							<label for="id-type" class="col-sm-4 control-label"><span
								style="color: red; margin-right: 5px;" id="itspan1s">*</span>补发工资单月份:</label>
							<div class="col-sm-4 selects">
