		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<%-- <a type="button" href="${ctx}/sys/user/info" class="btn btn-primary">点击查看</a> --%>
				</div>
			</div>
		</div>
	</div>
	<div class="modal fade bs-example-modal-lg" id="updateUserAddr"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content" id="contantDetail">
				...
				<form action="${pageContext.request.contextPath}/center/wagesParent/removeMain"
					...
					<div class="modal-body form-horizontal">
						...
						<div class="btns">
							<button type="submit" class="btn btn-danger" style="margin-right: 50px;">删除</button>
		...
		<div class="container-fluid" id="mains">
			<div class="left-container" id="left-container">
				...
				<ul>
					...
					<c:if test="${type!=1 }">
						<li><a href="${pageContext.request.contextPath}/center/wagesParent/checkPayroll" style="color: #ffb900;">查看主工资单</a></li>
			...
			<div class="main-container">
				<div class="search-form">
					<c:if test="${type==0 }">
						<form class="form-inline"
							action="${pageContext.request.contextPath}/center/wagesParent/checkPayroll"
							method="post">
							<div class="form-group">
								<label for="product-num">身份证号:</label>
								<input type="text" name="managerName" value="${queryParam.managerName }" class="form-control input-sm" id="product-num">
							...
							<button type="button" class="btn btn-primary" data-toggle='modal' data-target='#updateUserAddr'>一键删除</button>
						</form>
					</c:if>
				</div>
									...
									<td colspan="7">
										<span class="operation"> 
											<a href="javascript:void(0);">
												${wage.wagesYear }年${wage.wagesMonth }月主工资单
											</a>
										</span>
									</td>
								</tr>
								<tr>
									<td>${wage.managerName }</td>
									<td>${wage.wagesYear }</td>
									<td>${wage.wagesMonth }</td>
									<td>${wage.createByName }</td>
									<td>
										<fmt:formatDate value="${wage.createTime }" pattern="yyyy-MM-dd" />
									</td>
									<td>
										<font color="red"><fmt:formatNumber value="${wage.headerValue }" pattern="0.00" type="number" /></font>
									</td>
									<td>
										<form action="${pageContext.request.contextPath}/center/wagesParent/checkPayrollDetail"
											id="gopayFrom${i.index}" method="post">
											<input name="id" type="hidden" value="${wage.id }" />
										</form>
										<a type="button" class="btn btn-danger btn-sm" href="javascript:void(0);" onclick="gopay(${i.index})">详情</a>
										<br />
									</td>
								</tr>
							</tbody>
				...
				<div class="pages">
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayroll?page=1&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">首页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayroll?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">&lt;&lt;上一页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayroll?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">下一页&gt;&gt;</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayroll?page=${pageInfo.pages}&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">尾页</a>
