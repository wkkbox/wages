		...
		<div class="container-fluid" id="mains">
			<div class="left-container" id="left-container">
				...
				<ul>
					...
					<c:if test="${type==0 }">
						<li><a href="${pageContext.request.contextPath}/center/wagesParent/checkPayrollTotal" style="color: #ffb900;">主工资单合计</a></li>
			...
			<div class="main-container">
				<div class="search-form">
					<c:if test="${type==0 }">
						<form class="form-inline"
							action="${pageContext.request.contextPath}/center/wagesParent/checkPayrollTotal"
							method="post">
							<div class="form-group">
								<label for="product-num">主工资单合计&nbsp;&nbsp;</label>
					...
					<table class="table" id="order-title">
						...
						<c:forEach items="${pageInfo.list }" var="wage" varStatus="i">
							...
							<tbody class="table-bordered">
								<tr>
									<td><font color="red"><fmt:formatNumber value="${wage.yfTotal }" pattern="0.00" type="number" /></font></td>
				...
				<div class="pages">
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayrollTotal?page=1&rows=${pageInfo.pageSize}&year=${queryParam.year}&month=${queryParam.month}">首页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayrollTotal?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}&year=${queryParam.year}&month=${queryParam.month}">&lt;&lt;上一页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayrollTotal?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}&year=${queryParam.year}&month=${queryParam.month}">下一页&gt;&gt;</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkPayrollTotal?page=${pageInfo.pages}&rows=${pageInfo.pageSize}&year=${queryParam.year}&month=${queryParam.month}">尾页</a>
