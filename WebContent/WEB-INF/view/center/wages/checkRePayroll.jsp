	...
	<div class="modal fade bs-example-modal-lg" id="updateUserAddr"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content" id="contantDetail">
				...
				<form
					action="${pageContext.request.contextPath}/center/wagesParent/removeRe"
			...
			<div class="main-container">
				<div class="search-form">
					<c:if test="${type==0 }">
						<form class="form-inline"
							action="${pageContext.request.contextPath}/center/wagesParent/checkRePayroll"
							method="post">
							<div class="form-group">
							...
							<button type="button" class="btn btn-primary" data-toggle='modal'
								data-target='#updateUserAddr'>一键删除</button>
						</form>
					</c:if>
				</div>
						...
						<c:forEach items="${pageInfo.list }" var="wage" varStatus="i">
							...
							<tbody class="table-bordered">
								<tr style="background-color: #F1F1F1;">
									<td colspan="7"><span class="operation"> <a
											href="javascript:void(0);">${wage.wagesYear }年${wage.wagesMonth }月
												补发工资单</a>
									</span></td>
								</tr>
								<tr>
									...
									<td>
										<font color="red">
											<fmt:formatNumber value="${wage.headerValue }" pattern="0.00" type="number" />
										</font>
									</td>
									<td>
										<form
											action="${pageContext.request.contextPath}/center/wagesParent/checkRePayrollDetail"
				...
				<div class="pages">
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkRePayroll?page=1&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">首页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkRePayroll?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">&lt;&lt;上一页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkRePayroll?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">下一页&gt;&gt;</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/wagesParent/checkRePayroll?page=${pageInfo.pages}&rows=${pageInfo.pageSize}&managerName=${queryParam.managerName}&year=${queryParam.year}&month=${queryParam.month}">尾页</a>
