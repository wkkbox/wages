    ...
    <script type="text/javascript">
        ...
        function checkNewpassword() {
            ...
            if (newPassword != password) {
                ...
                b = false;
            } else if (!z.test(newPassword)) {
                $("#ctspan")
                    .html(
                        "&nbsp;&nbsp;<span  style='color:red' >密码必须为6-20位数字密码下划线@符号组成</span>");
                b = false;
            } else if (z.test(newPassword) && newPassword == password) {
                $("#ctspan")
                    .html(
                        "&nbsp;&nbsp;<span class='fa fa-check' style='color:green' ></span");
                $("#onspan").html(
        ...
        function checkEmail() {
            ...
            var z = /^[\w!#$%&'*+/=?^_`{|}~-]+(?:\.[\w!#$%&'*+/=?^_`{|}~-]+)*@(?:[\w](?:[\w-]*[\w])?\.)+[\w](?:[\w-]*[\w])?$/;
            if (!z.test(email)) {
                $("#emspan")
                    .html(
                        "&nbsp;&nbsp;<span  style='color:red' >请输入正确的邮箱</span>");
                d = false;
            } else {
                $("#emspan")
                    .html(
                ...
                <div class="form-group">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="${pageContext.request.contextPath}/center/manager/logout">&nbsp;&nbsp;&nbsp;退出系统&nbsp;&nbsp;&nbsp;</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><img class="personal-logo" src="${pageContext.request.contextPath}/resource/images/logo.png">
                    </li>
...
<div class="container-fluid" id="mains">
    <div class="left-container" id="left-container">
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/center/system/manager/skipEditPassword"
                   style="color: #ffb900;">修改密码</a></li>
            <c:if test="${type==1 }">
        ...
        <form class="form-horizontal" method="post"
            ...
            <div class="borders-info">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input id="chkEmail" type="text" class="form-control input-sm" name="mail" placeholder="请输入邮箱"
                               onblur="checkEmail()">
                    </div>
                    <div class="col-sm-4" style="margin-top: 7px;" id="emspan">
                        <span style="color:red">${msg }</span>
                    </div>
                </div>
                <div class="btns">
                    <button type="submit" class="btn btn-danger" style="margin-right: 50px;">提&nbsp;&nbsp;&nbsp;交
                    </button>
