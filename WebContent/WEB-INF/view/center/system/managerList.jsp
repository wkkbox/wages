			...
			<div class="left-container" id="left-container">
				...
				<ul>
					...
					<c:if test="${type==1 }">
						...
						<li><a href="${pageContext.request.contextPath}/center/system/manager/list" style="color: #ffb900;">员工管理</a></li>
					</c:if>
				</ul>
			</div>
			<hr>
			<div class="main-container">
				<div class="search-form">
					<form class="form-inline"
						action="${pageContext.request.contextPath}/center/system/manager/list"
						method="post">
						<div class="form-group">
							<label for="product-num">员工姓名:</label> <input type="text"
								name="manaherName" value="${queryParam.manaherName }"
								class="form-control input-sm" id="product-num">
						</div>
							...
							<tbody class="table-bordered">
								<tr style="background-color: #F1F1F1;">
									<!-- <td colspan="7"><span class="operation"> <a
											href="javascript:void(0);">员工数据</a>
									</span></td> -->
								</tr>
								<tr>
									<td>${log.accountName }</td>
									<td>${log.manaherName }</td>
									<td>${log.mail }</td>
									<td>
										<form action="${pageContext.request.contextPath}/center/system/manager/edit"
											id="gopayFrom${i.index}" method="post">
											<input name="managerId" type="hidden" value="${log.id }" />
										</form>
										<a type="button" class="btn btn-danger btn-sm"
										href="javascript:void(0);" onclick="gopay(${i.index})">密码重置</a>
									</td>
								</tr>
							</tbody>
						</c:forEach>
				...
				<div class="pages">
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/system/manager/list?page=1&rows=${pageInfo.pageSize}&manaherName=${queryParam.manaherName}">首页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/system/manager/list?page=${pageInfo.prePage}&rows=${pageInfo.pageSize}&manaherName=${queryParam.manaherName}">&lt;&lt;上一页</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/system/manager/list?page=${pageInfo.nextPage}&rows=${pageInfo.pageSize}&manaherName=${queryParam.manaherName}">下一页&gt;&gt;</a>
					<a class="btn btn-default btn-sm" role="button"
						href="${pageContext.request.contextPath}/center/system/manager/list?page=${pageInfo.pages}&rows=${pageInfo.pageSize}&manaherName=${queryParam.manaherName}">尾页</a>
